    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="glass-panel p-6 rounded-3xl border-white/10 space-y-2">
        <div className="flex items-center gap-3">
          <div className="p-2.5 rounded-2xl bg-[#05C46B]/20 text-[#00FF87] border border-[#05C46B]/40">
            <Calculator size={24} />
          </div>
          <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="glass-panel p-6 rounded-3xl space-y-5 border-white/10">
          <h2 className="text-lg font-bold text-white flex items-center gap-2">
            <Flag size={18} className="text-[#00FF87]" /> Select Course & Tees
          </h2>
        ...
        <div className="glass-panel p-6 rounded-3xl border-[#00FF87]/30 bg-gradient-to-b from-[#0C1A2E] to-[#070D18] flex flex-col justify-between space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-white/10 pb-4">
              ...
              <span className="text-xs font-extrabold text-[#00FF87]">
                {currentCourse?.name}
              </span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div className="p-3 bg-white/5 rounded-xl border border-white/10">
                <p className="text-[10px] text-slate-400 font-semibold">Course Rating</p>
                <p className="text-lg font-bold text-white font-['Outfit']">{rating}</p>
              </div>
              <div className="p-3 bg-white/5 rounded-xl border border-white/10">
                <p className="text-[10px] text-slate-400 font-semibold">Slope Rating</p>
                <p className="text-lg font-bold text-white font-['Outfit']">{slope}</p>
              </div>
              <div className="p-3 bg-white/5 rounded-xl border border-white/10">
                <p className="text-[10px] text-slate-400 font-semibold">Par</p>
                <p className="text-lg font-bold text-white font-['Outfit']">{par}</p>
              </div>
            </div>

            {/* Course Handicap Giant Output */}
            <div className="p-5 rounded-2xl bg-[#05C46B]/10 border border-[#05C46B]/40 text-center space-y-1">
              <p className="text-xs font-bold text-[#00FF87] uppercase tracking-wider">
              ...
              <p className="text-xs text-slate-300 font-medium">
                Subtract <span className="text-[#00FF87] font-bold">{courseHandicap} strokes</span> from your gross score for target net score!
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-between">
              ...
              <p className="text-3xl font-extrabold text-[#FFD700] font-['Outfit']">
                {playingHandicap}
              </p>
            </div>
          </div>
          ...
          <div className="p-3 rounded-xl bg-black/40 border border-white/5 text-[11px] text-slate-400 space-y-1">
            <p className="font-bold text-slate-300 flex items-center gap-1">
              <HelpCircle size={12} className="text-[#00FF87]" /> Official WHS Formula:
            </p>

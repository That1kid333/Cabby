...
export const HandicapCard: React.FC<HandicapCardProps> = ({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden glass-panel p-6 sm:p-8 rounded-3xl border border-[#05C46B]/30 bg-gradient-to-br from-[#0B1728] via-[#0E1B30] to-[#070D18]">
        
        {/* Decorative Background Glows */}
        <div className="absolute -top-24 -right-24 w-72 h-72 bg-[#05C46B]/15 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-[#FFD700]/10 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <span className="px-3 py-1 rounded-full text-xs font-bold bg-[#05C46B]/20 text-[#00FF87] border border-[#05C46B]/40 flex items-center gap-1.5">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-2">
              <button
                ...
                className="bg-gradient-to-r from-[#05C46B] to-[#00FF87] hover:opacity-90 text-[#070B16] font-extrabold px-5 py-2.5 rounded-xl shadow-lg shadow-[#05C46B]/20 transition-all text-sm flex items-center gap-2"
              >
          ...
          <div className="grid grid-cols-2 gap-3 w-full lg:w-auto">
            <div className="glass-panel p-4 rounded-2xl border-white/10 bg-white/5 space-y-1">
              ...
              <p className="text-[10px] text-slate-400 font-medium">Lowest stroke round</p>
            </div>
            ...
            <div className="glass-panel p-4 rounded-2xl border-white/10 bg-white/5 space-y-1">
              ...
              <p className="text-2xl font-extrabold text-[#00FF87] font-['Outfit']">
                {currentUser.bestDifferential === 99.9 ? '--' : currentUser.bestDifferential.toFixed(1)}
              </p>
              <p className="text-[10px] text-slate-400 font-medium">Course difficulty adjusted</p>
            </div>
            ...
            <div className="glass-panel p-4 rounded-2xl border-white/10 bg-white/5 space-y-1">
              ...
              <p className="text-[10px] text-slate-400 font-medium">Recorded in Cabby</p>
            </div>
            ...
            <div className="glass-panel p-4 rounded-2xl border-white/10 bg-white/5 space-y-1">
              ...
              <p className="text-[10px] text-slate-400 font-medium">Trophy highlights</p>
            </div>
          </div>
        ...
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div>
            <h2 className="text-lg font-bold text-white flex items-center gap-2">
              ...
              <span className="text-xs px-2 py-0.5 rounded-full bg-[#05C46B]/20 text-[#00FF87] border border-[#05C46B]/30">
                Top {differentialsUsed} Counted
              </span>
            </h2>
            <p className="text-xs text-slate-400">
              Rounds with an <span className="text-[#00FF87] font-semibold">emerald outline</span> are included in your official Handicap Index average.
            </p>
          </div>
        </div>
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-2xl border transition-all ${
                    isBest
                      ? 'bg-[#05C46B]/15 border-[#00FF87] shadow-md shadow-[#05C46B]/20 scale-[1.02]'
                      : 'bg-white/5 border-white/10 opacity-75 hover:opacity-100'
                  }`}
                >
                  <div className="flex items-center justify-between text-xs mb-1">
                    <span className="text-slate-400 truncate max-w-[80px]">{round.date}</span>
                    {isBest && <CheckCircle2 size={14} className="text-[#00FF87]" />}
                  </div>

                  <div className="flex items-baseline justify-between">
                    <span className={`text-xl font-extrabold font-['Outfit'] ${isBest ? 'text-[#00FF87]' : 'text-slate-200'}`}>
